...
const UpdateGroupChatModal = ({ fetchMessages, fetchAgain, setFetchAgain}) => {
    ...
    const [renameLoading, setRenamingloading] = useState(false)
            ...
            <Modal isOpen={isOpen} onClose={onClose} isCentered>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <FormControl display="flex">
                            <Input placeholder='Add users to the group ' mb={1} onChange={(e) => { handleSearch(e.target.value) }} />
